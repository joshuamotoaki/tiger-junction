...
bg-white dark:bg-black max-h-screen overflow-clip px-2">
    ...
    <div class="flex h-16 gap-4 mt-2">
        ...
        <!-- CourseGenie -->
        <AppCard on:click={() => goto("/coursegenie")}
        scheme="2">
            <div class="flex items-center justify-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class="flex h-16 gap-4 mt-2">
        <AppCard on:click={() => modalStore.open("rcolors", { clear: true })}
            scheme="-1">
                <div class="flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <AppCard on:click={() => modalStore.open("settings", { clear: true })}
            scheme="-1">
                <div class="flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
